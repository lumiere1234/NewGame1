...
Shader "Custom/SkyBox/Skybox - Scroll 3 Layers" {
Properties {
...
SubShader {
	...
	v2f vert (appdata_full v)
	{
		...
		float3 offsetUV = frac( float3(_ScrollX, _Scroll2X, _Scroll3X) * _Time.xxx);
		...
		o.uv3 = TRANSFORM_TEX(v.texcoord.xy,_DetailTex2) + float2(offsetUV.z, 0) ;
