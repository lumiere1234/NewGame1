...
Shader "Chp/Scroll/Unlit AlphaBlend Addtive 2 Scroll Turbulence " {
Properties {
...
SubShader {
	...
	pass{
		...
		fixed4 frag(vertexOutput i) : COLOR
		{
			...
			fixed4 mainTex = tex2D(_MainTex,i.uv_MainTex)  * _Color01 *2;
			...
			return fixed4( mainTex.rgb + (blendTex * blendTex1), mainTex.a)*i.color * _Lighten;
